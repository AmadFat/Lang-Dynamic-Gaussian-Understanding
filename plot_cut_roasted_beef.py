...
L1S_TRAIN = OrderedDict({
    5: 0.13971495058606653,
    20: 0.10358159244060516,
    60: 0.06456198893925723,
    200: 0.04448493986445315,
    1000: 0.04363476353533128,
    5000: 0.0176280802115798,
    20000: 0.011853948728564908,
})

PSNRS_TRAIN = OrderedDict({
    5: 14.701626216664033,
    20: 17.495447271010455,
    60: 20.288292379940255,
    200: 23.081290749942553,
    1000: 24.693147210513843,
    5000: 30.652316149543314,
    20000: 34.14770294638241,
})

L1S_TEST = OrderedDict({
    5: 0.11572901028044083,
    20: 0.0755170092863195,
    60: 0.052923163508667666,
    200: 0.03635347766034743,
    1000: 0.03527439319912125,
    5000: 0.017123696120346293,
    20000: 0.01424361644860576,
})

PSNRS_TEST = OrderedDict({
    5: 16.49209437650793,
    20: 19.994482601390164,
    60: 21.849057478063248,
    200: 24.3559710558723,
    1000: 26.31742051068474,
    5000: 31.38761307211483,
    20000: 32.83692954568302,
})
...
def plot_training_metrics():
    ...
    loss_annotation = ax0.annotate(f'Best: {min_loss_value:.6f}',
                ...
                xytext=(min_loss_iter*0.4, min_loss_value*2.15),
    ...
    train_annotation = ax1.annotate(f'Best: {min_train_value:.4f}',
                ...
                xytext=(min_train_iter*0.3, min_train_value*2.3),
    ...
    test_annotation = ax1.annotate(f'Best: {min_test_value:.4f}',
                ...
                xytext=(min_test_iter*0.4, min_test_value*2.85),
